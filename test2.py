"""Test 2 - Agent
This Agent solve minesweeper using a geedy method
"""

# Minesweeper Agent
from agent.greedy_minesweeper_agent import GreedyMinesweeperAgent
...
for mine_factor in mines_factor:
    games_won = 0
    agent = GreedyMinesweeperAgent(9, 9, mine_factor)
